...
exports.create = function (req, callback) {
    genericElasticCreate(req, callback, whereToSearch, SANGER_CONSTATNTS['product_data']);
};

exports.update = function (req, callback) {
    genericElasticUpdate(req, callback, whereToSearch, SANGER_CONSTATNTS['product_data']);
};
